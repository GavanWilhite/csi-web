...
export const keynotes: Keynote[] = [
  ...
  },
  {
    ...
    epithet: "COGNITIVE WARFARE & THE INFO ENVIRONMENT",
    image: "/assets/speakers/terri-borras.jpeg",
    linkedin: "https://www.linkedin.com/in/aidatborras/",
  },
  {
    name: "ASHLEY ROSE",
    epithet: "PIONEER OF HUMAN RISK MANAGEMENT",
    image: "/assets/speakers/ashley-rose.avif",
...
export const moreSpeakersCount = 28;
...
export const sponsors: Sponsor[] = [
  { name: "Living Security", logo: "/assets/sponsors/living-security.png", maxHeight: 34 },
  { name: "Fable", logo: "/assets/sponsors/fable.png", maxHeight: 30 },
  ...
  { name: "HRL Laboratories", logo: "/assets/sponsors/hrl-laboratories.png", maxHeight: 36 },
